...
import { MdPlayArrow, MdSmartDisplay, MdDownload } from "react-icons/md";
...
const SongList = () => {
  ...
  const rows = songs.map((song) => (
    <tr  key={song.id}>
      <td className="text-white hover:scale-105 cursor-pointer select-none">{song.id}.</td>
      <td className="text-white hover:scale-105 cursor-pointer select-none">{song.name}</td>
      <td className="text-white hover:scale-105 cursor-pointer select-none">{song.duration}</td>

      <td className="text-white  cursor-pointer select-none">
        <a href={song.url}>
          <MdPlayArrow  className="text-xl hover:text-black"/>{" "}
        </a>
      </td>
      <td className="text-white  cursor-pointer select-none">
        <a href={song.Uurl}>
          <MdSmartDisplay className="text-xl hover:text-black" />{" "}
        </a>
      </td>
      <td className="text-white  cursor-pointer select-none">
